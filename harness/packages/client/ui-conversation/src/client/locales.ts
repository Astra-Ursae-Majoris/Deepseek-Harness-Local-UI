...
export const en = {
  ...
  'message.rewind': 'Rewind to here',
  'message.regenerate': 'Regenerate',
  'nav.open': 'Conversation outline',
  'nav.close': 'Collapse outline',
  'nav.latest': 'Back to latest',
  'nav.loading': 'Loading outline…',
  'nav.empty': 'No conversation turns yet',
  'nav.turn': 'Turn {n}',
  'nav.you': 'you',
  'nav.me': 'me',
  'nav.running': '(generating…)',
  'nav.toolOnly': '(tool work)',
  'nav.noReply': '(no text reply)',
