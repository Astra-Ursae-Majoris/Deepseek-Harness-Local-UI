...
import {
  IconBranchOutline16, IconCheckOutline16, IconChevronLeftOutline14, IconCopyOutline16,
...
export interface MessageIconActionsProps {
  ...
  /** Rewind the session to before this message (fork before its turn and open the child). */
  onRewind?: (() => void) | undefined
  /** Regenerate: rewind to before this message, then resend its text in the child. */
...
export function MessageIconActions({
  ...
  onRewind, onRegenerate, className, extraActions, t,
